    ...
    <div className="studio-page">
      <div className="studio-header">
        <div>
          ...
          <p>Ubah detail proyek, tentukan foto cover utama, atau perbarui galeri screenshot.</p>
        </div>
        <div className="studio-actions">
          ...
          >
            <Bot size={16} /> {copilotLoading ? "Menganalisis..." : "AI Copilot Polish"}
          </button>
        </div>
      </div>
      ...
      {success && (
        <div className="studio-alert studio-alert-success">
          <Check size={16} />
          <span>Proyek berhasil disimpan! Mengalihkan...</span>
        </div>
      )}
      ...
      {copilotSuggestion && (
        <div className="studio-ai-card">
          <div className="studio-ai-card-head">
            <div className="flex items-center gap-2">
              <Bot size={18} className="text-cyan-400" />
              <strong>Saran Optimasi AI Copilot</strong>
            </div>
            <button
              type="button"
          ...
          <p className="studio-ai-rationale">{copilotSuggestion.rationale}</p>
          <div className="studio-ai-diff">
            <div className="studio-ai-diff-col">
              <label>Teks Asli</label>
              <p>{copilotSuggestion.originalValue}</p>
            </div>
            <div className="studio-ai-diff-col highlight">
              <label>Saran AI yang Ditingkatkan</label>
          ...
          <div className="studio-ai-actions">
            ...
            >
              <Check size={14} /> Terapkan Saran Ini
            </button>
            <button
              type="button"
              onClick={() => setCopilotSuggestion(null)}
      ...
      <form onSubmit={handleSubmit} className="studio-form-grid">
        ...
        <div className="studio-card">
          ...
          <div className="studio-field">
            ...
            <input
              ...
              onChange={handleChange}
              placeholder="Tagline singkat proyek..."
              required
            />
          </div>
          ...
          <div className="studio-field">
            ...
            <textarea
              ...
              onChange={handleChange}
              placeholder="Deskripsi mendalam..."
              required
            />
          </div>
        </div>
        ...
        <div className="studio-card">
          ...
          <p className="studio-subtext">
            Sebutkan ukuran tim dan peran spesifik secara transparan dan detail.
          </p>
          ...
          <div className="studio-field">
            ...
            <textarea
              ...
              onChange={handleChange}
              placeholder="Jelaskan peran masing-masing anggota tim atau jika dikerjakan mandiri..."
            />
          </div>
