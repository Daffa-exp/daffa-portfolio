...
const context = (slug: string, count = 1, ext = ".webp") =>
  Array.from({ length: count }, (_, i) => `/assets/projects/${slug}/context/${i + 1}${ext}`);
...
export const featuredProjects: Project[] = [
  {
    ...
    images: imgs("foodmart", 3), contextImages: context("foodmart", 3),
  ...
  },
  {
    ...
    images: imgs("instanpage", 1), contextImages: context("instanpage", 1),
  ...
  },
  {
    ...
    images: imgs("pariwisata", 7), contextImages: context("pariwisata", 1),
    demo: "https://soft-florentine-811c65.netlify.app/", featured: true
  }
];

export const moreProjects: Project[] = [
  { id:"kaskelas", name:"Kas Kelas", category:"DESKTOP APP", tagline:"Sistem manajemen keuangan kelas digital", desc:"Aplikasi desktop untuk mengelola kas kelas, tunggakan dan kredit siswa, grafik analitik keuangan, pembayaran QR code, serta export laporan.", stack:["Electron","Node.js","Express"], images:imgs("kaskelas",6), contextImages:context("kaskelas") },
  { id:"hubin", name:"Hubin", category:"DESKTOP APP", tagline:"Pengelolaan hubungan industri sekolah", desc:"Aplikasi desktop untuk mengelola data siswa PKL, kunjungan industri, dan MoU sekolah, lengkap dengan alur pengelolaan data.", stack:["Electron","Express"], images:imgs("hubin",3), contextImages:context("hubin") },
  { id:"exam", name:"Exam Monitoring System", category:"AI / COMPUTER VISION", tagline:"Pemantauan ujian berbasis AI", desc:"Sistem monitoring ujian yang memanfaatkan deteksi wajah untuk membantu pemantauan peserta secara real-time.", stack:["Python","Flask","OpenCV","MediaPipe"], images:imgs("exam",1), contextImages:context("exam") },
  { id:"galerifoto", name:"Galeri Foto Native", category:"WEB APP", tagline:"Galeri foto dengan sistem like & profil", desc:"Aplikasi web galeri foto dengan autentikasi pengguna, upload foto, sistem like berbasis AJAX, dan halaman profil pengguna.", stack:["PHP","MySQL","AJAX"], images:imgs("galerifoto",4), contextImages:context("galerifoto") },
  { id:"phonebook", name:"Web Phone Book", category:"WEB APP", tagline:"Manajemen kontak berbasis web", desc:"Aplikasi pengelolaan kontak dengan login, tambah dan lihat data kontak lengkap dengan foto profil.", stack:["PHP","MySQL"], images:imgs("phonebook",5), contextImages:context("phonebook") },
  { id:"webwedding", name:"Web Wedding Invitation", category:"WEB EXPERIENCE", tagline:"Undangan pernikahan digital", desc:"Undangan pernikahan digital interaktif dengan animasi pembuka dan tampilan modern.", stack:["Next.js","TypeScript","Tailwind CSS"], images:imgs("webwedding",6), contextImages:context("webwedding") },
  { id:"mobilelms", name:"Mobile LMS", category:"MOBILE APP", tagline:"Aplikasi pembelajaran online sederhana", desc:"Aplikasi pembelajaran dengan kategori jenjang pendidikan, daftar kelas, dan sistem poin belajar.", stack:["Flutter","Dart","JavaScript","Tailwind CSS"], images:imgs("mobilelms",2), contextImages:context("mobilelms",1) },
  { id:"jersey", name:"Pendataan Pembayaran DP", category:"UTILITY WEB", tagline:"Tools pencatatan pembayaran jersey kelas", desc:"Tools ringan untuk mencatat pembayaran DP dan pelunasan, dengan progress pembayaran per orang.", stack:["HTML","JavaScript"], images:imgs("jersey",2), contextImages:context("jersey") },
  ...
  { id:"webbolu", name:"Bolu Pinky", category:"E-COMMERCE", tagline:"E-commerce kue rumahan dengan live chat", desc:"Website e-commerce bakery dengan katalog produk, keranjang, checkout, dan live chat real-time.", stack:["Supabase","JavaScript","Realtime Chat"], images:imgs("webbolu",5), contextImages:context("webbolu") },
